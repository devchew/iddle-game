...
import { transformResearchTree, connectEntitiesToResearchTree } from './utils/dataTransformers';
      ...
      <Box sx={{ bgcolor: '#f5f5f5', minHeight: '100vh' }}>
        <Container maxWidth="xl" sx={{ py: 4 }}>
          ...
          <Typography variant="subtitle1" color="text.secondary" align="center" sx={{ mb: 4 }}>
            A visual exploration of the research tree and entities in Idle Factory
          </Typography>
              ...
              <Route index element={
                <Box>
                  ...
                  <Typography variant="body1" paragraph>
                    This tree shows the research progression structure. Green nodes contain entities that 
                    are unlocked by that research. Click on any green node to see the related entities.
                  </Typography>
                  <ResearchTreeVisualizer treeData={connectedTreeData} />
                </Box>
              } />
              <Route path="entities" element={<EntitySearch entities={entities.entities} />} />
            </Route>
          </Routes>
        </Container>
      </Box>
